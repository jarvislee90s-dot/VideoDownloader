...
from video_downloader.downloader import download, _get_proxy_for_url
from video_downloader.config import DEFAULT_OUTPUT_DIR
...
def run():
    ...
    #    输出目录固定到项目根目录下，避免从其他目录（如根目录）运行时把 ./downloads 解析到只读路径。
